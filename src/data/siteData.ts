...
export const siteDataZh = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "我们专注于高安全、长寿命磷酸铁锂（LFP）电芯应用，产品通过 ISO9001、CE、UN38.3 等多项国际权威认证，广泛服务于全球电动船舶、工商业储能等高端市场。"
    ],
    stats: [
      { num: "15+", label: "行业沉淀经验" },
      { num: "20+", label: "研发专利授权" },
    ...
    items: [
      {
        ...
        icon: "🛡️",
        title: "极致安全防御",
        desc: "采用多重热失控防护技术与全固态安全隔膜，结合车规级防爆泄压设计，从源头杜绝电池安全隐患。"
      },
      {
        num: "02",
        icon: "⚡",
        title: "超长循环寿命",
        desc: "搭载高稳定 LFP 磷酸铁锂材料与自研功能性电解液配方，常温循环寿命突破 6000+ 次，全生命周期成本更低。"
      },
      {
        num: "03",
        icon: "🧠",
        title: "智能 BMS 管理",
        desc: "自研云端 BMS 电池管理系统，支持全天候热失控预警与高精度算法，精准估算 SOC 与 SOH 健康状态。"
      },
      {
        num: "04",
        icon: "⚓",
        title: "深海级防腐防爆",
        desc: "整包通过 IP67 防水防盐雾腐蚀测试，加固抗海浪冲击箱体，全面满足国际严苛的海事安全规范。"
      }
    ]
  },
